                ...
                if ((c = b instanceof THREE.Mesh || b instanceof THREE.Line))
                    if (!(c = b.frustumCulled === !1)) a: {
                        for (var d = b.matrixWorld, e = -b.geometry.boundingSphere.radius * Math.max(b.scale.x, Math.max(b.scale.y, b.scale.z)), h = 0; h < 6; h++)
                            if (((c = r[h].x * d.n14 + r[h].y * d.n24 + r[h].z * d.n34 + r[h].w), c <= e)) { c = !1; break a; }
                        c = !0;
                    }
            ...
            if (((J = w.objects[a].object), (t = J.matrixWorld), (x = J.material), (m = 0), J instanceof THREE.Mesh)) {
                ...
                for (L = M.length; S < L; S++) {
                    ...
                    for (R = la.length; v < R; v++)
                        if ((fa = la[v][S])) { P = 0; for (V = fa.length; P < V; P++) j.uvs[v][P] = fa[P]; }
                    j.material = x;
...
THREE.Geometry.prototype = {
    ...
    computeTangents: function() {
        ...
        var H = ["a", "b", "c", "d"];
        b = 0;
        for (c = this.faces.length; b < c; b++) { e = this.faces[b]; for (d = 0; d < e.vertexNormals.length; d++) G.copy(e.vertexNormals[d]), (f = e[H[d]]), (D = u[f]), W.copy(D), W.subSelf(G.multiplyScalar(G.dot(D))).normalize(), da.cross(e.vertexNormals[d], D), (f = da.dot(r[f])), (f = f < 0 ? -1 : 1), (e.vertexTangents[d] = new THREE.Vector4(W.x, W.y, W.z, f)); }
        this.hasTangents = !0;
    },
...
THREE.CanvasRenderer = function(a) {
    ...
    this.render = function(a, j) {
        ...
        function s(a, e, g) {
            ...
            c(g.blending);
            var h, j, i, m, q, n;
            if (g instanceof THREE.ParticleBasicMaterial) { if (g.map)(m = g.map.image), (q = m.width >> 1), (n = m.height >> 1), (g = e.scale.x * o), (i = e.scale.y * p), (h = g * q), (j = i * n), X.set(a.x - h, a.y - j, a.x + h, a.y + j), ma.intersects(X) && (k.save(), k.translate(a.x, a.y), k.rotate(-e.rotation), k.scale(g, -i), k.translate(-q, -n), k.drawImage(m, 0, 0), k.restore()); } else
        ...
        function Aa(a, b, c, d, e, g, h, i, j, m, o, n, l) {
            if (l.image.width != 0) {
                ...
                if (p == 0) {
                    ...
                    (p = 1 / p), (l = (n * c - m * e) * p), (m = (n * d - m * g) * p), (c = (j * e - o * c) * p), (d = (j * g - o * d) * p), (a = a - l * h - c * i), (h = b - m * h - d * i), k.save(), k.transform(l, m, c, d, a, h), k.fill(), k.restore();
            }
        }
